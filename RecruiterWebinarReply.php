...
<title>Recruiter Reply Forum</title>
<!-- Favicon -->
			...
			?>
                         <table width="800" border="0">
                          <tr>
                            ...
                            <td width="350" rowspan="2" valign="top" align="justify">
...
?>
     ...
     <!--  Edit Page -->
            <form name="frm" id="frm" action="saveRecruiterWebinarReply.php" method="post" onSubmit="return chkval();">
