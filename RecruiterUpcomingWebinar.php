...
<title>Scheduled Webinar details</title>
<!-- Favicon -->
		...
		<div class="section">
           ...
           <?php
                      ...
                      <p class="post-subtitle" style="font-size:12px;">Start Time: <?php print $stdt." To ".$stte; ?></p> <p class="post-subtitle" style="font-size:12px;">End Time : <?php print $endt." To ".$ente; ?></p> 
							...
							{
							?>
                            <a href="webinarStudentDetails.php?webid=<?php print $webinar_key;  ?>" class="button-big red" title="View Registrant for webinar">View Registrants</a>
                            <?php
							}
							?>
