...
$sqlInsert = "insert into recruiter_jopposting (Job_title,Job_id,Job_Dept,Job_Detail,Company_Name,Date_Post,Dead_line,recruiter_id) values ('$job_title','$job_id','$jbdept','$jbdetails','$companyName',NOW(),'$dead_line','$recruit_id')";
