...
<div class="section">
            <div class="grid_20"> 
                ...
                <div class="title"><h4>Inbox</h4></div>
				 ...
				 <ul class="sidebar">                       
                 <li>
                 <form id="frm" name="frm" action="recruiterSearchInbox.php" method="post" onsubmit="return chkval();">
                  ...
                  <input type="submit" value="Search" style="cursor:pointer;" />
					...
					<li><a href="RecruiterComposeMessage.php" title="Compose Message">Compose Message</a></li>
                    <li><a href="recruiterInbox.php" title="Inbox">Inbox (<?php print $rowcount; ?>)</a></li>
                    <li><a href="recruiterSend.php" title="Send">Sent</a></li>
                    <li><a href="recruiterArchive.php" title="Archived">Archived</a></li>
                    <li><a href="recruiterTrash.php" title="Trash">Trash</a></li>
