...
function chkoldpass(opass)
{
	...
	xmlhttp.open("GET","ajaxpage/ajaxrecruiterpasschk.php?opass="+opass+"&userid="+userid,true);
	xmlhttp.send();
}
        ...
        <div id="pageheader-background"><!-- area with alternate background -->
            <div class="pageheader-title">
             <span class="mailno"><?php include "RecruiterUnreadMail.php"; ?></span>
                <h1>Account Settings</h1><span style="margin:0px 30px 10px 0px; float:right;">
...
City &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; : &nbsp;&nbsp;<?php print $Address; ?><br><br></div>
                </div>
