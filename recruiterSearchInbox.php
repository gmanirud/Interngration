...
<div id="wrapper">
    ...
    <div id="header-buffer"></div><!-- hack for header overlap **DONT'TOUCH** -->
        ...
        <div id="pageheader-background"><!-- area with alternate background -->
            ...
            <span class="mailno"><?php include "RecruiterUnreadMail.php"; ?></span>
                <h1>Recruiter Inbox</h1><span style="margin:0px 30px 10px 0px; float:right;">
  ...
  <form action="recruiterInbxChkVal.php" method="post" id="frm" name="frm">
					   	<!-- tabs -->
		<div class="section">
		...
		$sql1="Select *  from student_mailbox where to_mail LIKE '%".$keyword."%' OR subject LIKE '%".$keyword."%' OR message LIKE '%".$keyword."%' order by SendDate desc ";
		...
		{	
		 $i++;
			...
			?>
                ...
                <div class="post-out-message">     
					   <a href="RecruiterInboxView.php?eid=<?php print $eid; ?>"> <div class="header-message" <?php if($flg_read=="0") { ?> style="background-color:#B4B4B4" <?php } ?>>
