...
if(move_uploaded_file($_FILES['txtFile']['tmp_name'], $target_path1)) 
{
	//echo "The file ".  basename( $_FILES['txt_invoice']['name'])." has been uploaded";
	   ...
	   $Coins=$res["Coins"];
		...
		{
		   $totcoin=$Coins+150;
		   $sqlUpdate ="Update student_register set Coins='$totcoin', imgcoinflg='1' where session_id='$sId'";
	       $result=mysql_query($sqlUpdate);
		} 
 
$sql="update student_register set Profile_Image='$profileImage' where session_id='$sId'";
