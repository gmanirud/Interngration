...
<div id="wrapper">
    ...
    <div class="clear"></div>
        ...
        <!-- side bar --><?php include "mailsidebarRecruiter.php"; ?>
        <!-- end side bar -->    
		...
		$sqlget="Select *  from student_mailbox where group_id='".$repid."'";
		...
		{	
			...
			$toSendMail=$toSendMail."\"".$UserName."\""."&lt ".$to_mail." &gt,";
			}
			
			$sqlrmid1="Select *  from recruiter_register where Email='".$to_mail."'";
...
<form id="frmProfile" action="sendRecruiterMail.php" method="post" onSubmit="return chkvalid();">
		...
		<div style="margin:0px 0px 10px 10px;">Subject: <input name="subject_mail" id="subject_mail" type="text" value='<?php print $subject;?>' style="margin:10px 0px 0px 10px;  width:250px;"></div>
                          </div></div>
