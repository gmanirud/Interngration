...
class Citrix
{
	...
	*/	
	...
	function citrixonline_get_list_of_webinars() 
    {
		...
		$reponse = json_decode($this->make_request("https://api.citrixonline.com/G2W/rest/organizers/384723869081067013/upcomingWebinars?oauth_token=4f8530d951f7963ce4180253c531c3f6 "), true);
	...
	*/
    function citrixonline_create_registrant_of_webinar($webinar_id=false, $data = array(), $all_fields_chk = false) 
    {
		...
		//{
			...
			$reponse = json_decode($this->make_request("https://api.citrixonline.com/G2W/rest/organizers/384723869081067013/webinars/".$webinar_id."/registrants", $params), true);
