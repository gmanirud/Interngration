...
<div id="wrapper">
    ...
    <div id="header-content">
        ...
        <div id="menu" class="menu"> 
               <ul><li><a href="student-homepage.php">Home</a></li></ul>
                <br style="clear: left" />
        </div>
        <!-- end header nav menu-->
 </div> </div> </div>
  ...
  <form action="studentArchiveChkVal.php" method="post" id="frm" name="frm">
					   	<!-- tabs -->
		<div class="section">
        ...
        <input name="chkbx<?php print $i; ?>" id="chkbx[]" type="checkbox" value="<?php print $eid; ?>" style="float:left; margin:10px 10px 50px 10px;"><h4><a href="studentArchiveView.php?eid=<?php print $eid; ?>"><?php print $sendername; ?> - <?php print $subject; ?> </h4>
