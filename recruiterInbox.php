...
<title>Recruiter Received Messages - Interngration</title>
<!-- Favicon -->
...
<div id="wrapper">
        ...
        <div id="pageheader-background"><!-- area with alternate background -->
            <div class="pageheader-title">
             ...
             <span class="mailno"><?php include "RecruiterUnreadMail.php"; ?></span>
                ...
                <h1>Received Messages</h1><span style="margin:0px 30px 10px 0px; float:right;">
  ...
  <form action="recruiterInbxChkVal.php" method="post" id="frm" name="frm">
       ...
       <input name="chkbx<?php print $i; ?>" id="chkbx[]" type="checkbox" value="<?php print $eid; ?>" style="float:left; margin:10px 10px 50px 10px;"><h4> <a href="RecruiterInboxView.php?eid=<?php print $eid; ?>"><?php print $sendername; ?> - <?php print $subject; ?> </h4>
