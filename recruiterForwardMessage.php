...
?>
<?php 
include "studentToEmail.php"; ?>
<!DOCTYPE HTML>
<html lang="en" class="no_js">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Forward Compose Message</title>
<!-- Favicon -->
...
<div id="wrapper">
    ...
    <!-- page header -->
       <div id="pageheader-background"><!-- area with alternate background -->
            <div class="pageheader-title">
                <h1>Forward Compose Message</h1><span style="margin:0px 30px 10px 0px; float:right;">
    ...
    <div class="clear"></div>
		...
		$sqlget="Select *  from student_mailbox where id='".$fwpid."'";
		...
		{	
			...
			$sqlrmid="Select *  from student_register where Email='".$to_mail."'";
			...
			$toSendMail="\"".$UserName."\""."&lt ".$to_mail." &gt,";
...
<form id="frmProfile" action="sendRecruiterMail.php" method="post" onSubmit="return chkvalid();">
            ...
            <div class="grid_22">
                ...
                <a href = "recruiterInbox.php"><input type="button" name="cancel" value="Cancel" class="button white" style="width:70" /></a> 
		...
		<div style="margin:0px 0px 10px 10px;">Subject: <input name="subject_mail" id="subject_mail" type="text" value="FW:<?php print $subject;?>" style="margin:10px 0px 0px 10px;  width:250px;"></div>
                          </div></div>
