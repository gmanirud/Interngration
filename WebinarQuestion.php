      ...
      <!-- page header -->
        <div id="pageheader-background"><!-- area with alternate background -->
            ...
            <span class="mailno"><?php include "StudentUnreadMail.php"; ?></span>
                <h1>Post Your Question</h1><span style="margin:0px 30px 0px 0px; float:right;">
...
?>
     ...
     <!--  Edit Page -->
            <form name="frm" id="frm" action="saveWebinarQuestion.php" method="post" onSubmit="return chkval();">
              ...
              <tr bgcolor="#e53f3f">
               ...
               <?php
					   ...
					   <!-- post 4 -->
                        ...
                        <td><a href="WebinarReply.php?qid=<?php print $id; ?>">See Replies</td>                   
                        </tr>
