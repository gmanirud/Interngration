...
<div id="wrapper">
  ...
  <form action="studentSendChkVal.php" method="post" id="frm" name="frm">
					   	<!-- tabs -->
		<div class="section">
		...
		$i++;
			...
			//  To Get Recevier's Name from student and Recruiter Table
       ...
       <input name="chkbx<?php print $i; ?>" id="chkbx[]" type="checkbox" value="<?php print $eid; ?>" style="float:left; margin:10px 10px 50px 10px;"><h4><a href="studentSentView.php?eid=<?php print $eid; ?>">To : <?php print $sendername; ?> - <?php print $subject; ?> </h4>
