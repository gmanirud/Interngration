...
<title>Recruiter Send Mail</title>
<!-- Favicon -->
...
<div id="wrapper">
    ...
    <div id="header-buffer"></div><!-- hack for header overlap **DONT'TOUCH** -->
      ...
      <div id="pageheader-background"><!-- area with alternate background -->
            ...
            <span class="mailno"><?php include "RecruiterUnreadMail.php"; ?></span>
                <h1>Recruiter Send Mail</h1><span style="margin:0px 30px 10px 0px; float:right;">
 ...
 <form action="recruiterSendChkVal.php" method="post" id="frm" name="frm">
					   	<!-- tabs -->
		<div class="section">
		...
		$sqlget="Select *  from student_mailbox where from_mail='".$mail_id."' AND flg_snd_arch='NIL' AND flg_snd_del='NIL'  order by SendDate desc ";
	   ...
	   $i="0";
		...
		$i++;
			...
			//  To Get Sender's Name from student and Recruiter Table
				    $sql2="Select *  from student_register where Email='".$to_mail."'";
					...
					$sql3="Select *  from recruiter_register where Email='".$to_mail."'";
        ...
        <input name="chkbx<?php print $i; ?>" id="chkbx[]" type="checkbox" value="<?php print $eid; ?>" style="float:left; margin:10px 10px 50px 10px;"><h4><a href="RecruiterSentView.php?eid=<?php print $eid; ?>">To : <?php print $sendername; ?> - <?php print $subject; ?> </h4>
